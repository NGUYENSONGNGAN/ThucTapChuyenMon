...
namespace ThucTapCM
{
    public partial class FormChat : Form
    {
        ...
        void Send(Socket client)
        {
            ...
            if ((client != null) && (txtType.Text != string.Empty))
            {
                client.Send(Serialize("Admin: " + txtType.Text));
            }
        }
        ...
        {
            lbmessage.Items.Add(new ListViewItem() { Text = s });
        }
